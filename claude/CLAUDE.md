...
~/.config/systemd/user  photo-drop.service, model-view.service (marketing 3D model inspector for the phone,
                        http://100.93.13.127:8125/), zellij-main.{service,timer} (all in .dotfiles/systemd/user)
